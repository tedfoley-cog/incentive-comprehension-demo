...
When the playbook runs, Devin produces (target shape, confirm framework with
the team):
...
The target stack (Java 21 + Spring Boot 3) is a **proposal**; the conversion
playbook flags it for confirmation with the team before code is generated.
